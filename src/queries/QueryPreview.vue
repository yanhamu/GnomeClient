...
export default {
  ...
  created: function() {
    ...
    this.query.accounts.forEach(a => {
      data.accounts.push(a.id);
    });
    this.query.includeExpressions.forEach(a => {
      data.includeExpressions.push(a.id);
    });
    this.query.excludeExpressions.forEach(a => {
      data.excludeExpressions.push(a.id);
    });
